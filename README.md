...
Revision notes for **6CCSAALA Advanced Logics in Artificial Intelligence** (25~26 SEM2 000001).

This repo collects my study materials for the module, organised by week (Weeks 1–11).

## Contents

- **`AdvancedLogic/notes/`**: written revision notes for each week (`WeekN_notes.md`).
- **`AdvancedLogic/mcqs/`**: multiple-choice practice questions per week (`WeekN_mcqs.json`).
- **`AdvancedLogic/flowcharts/`**: flowcharts summarising key concepts, as both JSON and rendered HTML.
- **`AdvancedLogic/data/WeekN/`**: source materials for each week: lecture slides, lecture notes, tutorial sheets and solutions, video transcripts, and learning objectives.
